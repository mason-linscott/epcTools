...
<!-- badges: end -->
  ...
  epcTools (**e**co**p**hysiological **c**onstrained trait **Tools**), is a R package designed to identify how the environment influencces parameters of Ornstein Uhlenbeck models of trait evolution. Currently it does this for only a single trait.
